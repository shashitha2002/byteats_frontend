// src/app/components/deliveryPerson-sidebar/page.tsx
"use client";
import { PackageOpen, ShoppingBag, PackageCheck, Truck,User } from "lucide-react";
    ...
    <Sidebar className="min-h-screen bg-white shadow-lg">
      ...
      <SidebarFooter className="p-4 mt-auto">
        <div className="border-2 border-gray-300 rounded-xl px-4 py-3 bg-gradient-to-r from-gray-600 to-gray-800 text-white shadow-md text-center">
          <h1 className="text-lg font-semibold">{deliveryPerson?.name || "Guest"}</h1>
        </div>
      </SidebarFooter>
    </Sidebar>
  );
